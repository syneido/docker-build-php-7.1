...
RUN_DEPS="unzip libzip icu libxslt imagemagick libmcrypt unixodbc recode tidyhtml freetype libjpeg-turbo libpng libwebp libxpm unixodbc"
BUILD_DEPS="autoconf g++ make libzip-dev zlib-dev libpng-dev libxml2-dev icu-dev unixodbc-dev bzip2-dev libc-dev gmp-dev libmcrypt-dev recode-dev gettext-dev tidyhtml-dev libxslt-dev imagemagick-dev freetype-dev libjpeg-turbo-dev libpng-dev libwebp-dev libxpm-dev tzdata unixodbc-dev"
